...
#         "/home/vk352/FaceDetection/datasets/celeba/Img_cropped/test/"
            ...
            for i_file in range(0, len(filenames), 5):
                ...
                imgs = torch.stack(imgs_all[i_file:i_file+5], 0).to(device)
...
#                 filename = os.path.splitext(os.path.basename(args.files[0]))[0] + ".pt"
                ...
                for i, input_name in enumerate(filenames[i_file:i_file+5]):
                    noise_single = []
                    for noise in noises:
...
#                     img_name = os.path.splitext(os.path.basename(input_name))[0] + "-project.png"
                    ...
                    pil_img.save("/home/vk352/FaceDetection/datasets/celeba/gan/"+folder+'/'+input_name)
