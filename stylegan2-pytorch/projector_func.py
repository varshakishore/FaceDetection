...
def getVector(ckpt, size, files, lr_rampup=0.05, lr_rampdown=0.25, lr=0.1, anoise=0.05, noise_ramp=0.75, step=1000, anoise_regularize=1e5, mse=0, w_plus=False):
    device = "cuda"
    ...
    for i in pbar:
        ...
        loss = p_loss + anoise_regularize * n_loss + mse * mse_loss
    ...
    return g_ema, latent_path, noises
